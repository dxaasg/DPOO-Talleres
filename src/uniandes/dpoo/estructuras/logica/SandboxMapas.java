...
public class SandboxMapas
{
    ...
    {
    	ArrayList<String>listaValores = new ArrayList<>(mapaCadenas.values());
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        listaLlaves.sort(Comparator.reverseOrder());
        return listaLlaves;
    }
    ...
    public String getPrimera( )
    {
    	...
    	for (String llave : mapaCadenas.keySet()) {
            if (cadenaMenor == null || llave.compareTo(cadenaMenor) < 0) {
                cadenaMenor = llave;
            }
    	}
        return cadenaMenor;
    ...
    public String getUltima( )
    {
    	...
    	for (String llave : mapaCadenas.keySet()) {
            if (cadenaMayor == null || llave.compareTo(cadenaMayor) > 0) {
                cadenaMayor = llave;
            }
    	}
        return cadenaMayor;
    ...
    public Collection<String> getLlaves( )
    {
        ...
        ArrayList<String> llavesMayusculas = new ArrayList<>();
    ...
    public void volverMayusculas( )
    {
        ...
        for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
            // Convertimos ambos a mayúsculas para mantener la lógica de inversión
            String nuevaLlave = entry.getKey().toUpperCase();
            String nuevoValor = entry.getValue().toUpperCase();
            nuevoMapa.put(nuevaLlave, nuevoValor);
        }
